...
callbacks = [
    keras.callbacks.ModelCheckpoint(
        "Transformer_best_model_vector.h5", save_best_only=True, monitor="sparse_categorical_accuracy"
    ),
...
model = keras.models.load_model("Transformer_best_model_vector.h5")
